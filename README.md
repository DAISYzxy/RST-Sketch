...
# Data
We release the testing data examples, including parsed RST DT files, selected EDUs, generated summaries, and QA pairs produced by the retention rate agent, at: [Google Drive link](https://drive.google.com/drive/folders/1LHShCrS9HTRx9kIx3QNbDaR7kHaggdPW?usp=sharing).
